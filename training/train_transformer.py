"""
Training script for Transformer-based 2048 AI.
...
from models.transformer import TransformerPolicy, DualTransformerPolicy
...
def train(args):
    ...
    if args.resume:
        ...
        checkpoint_info = load_checkpoint(
            ...
            model,
            optimizer,
            warmup_scheduler if start_epoch < args.warmup_epochs else cosine_scheduler,
            device
        )
    ...
    # Save training history (merge train and val trackers)
    history_path = log_dir / 'training_history.json'
    combined_history = {**train_tracker.history, **val_tracker.history}
    # Also save learning rates
...
def main():
    parser = argparse.ArgumentParser(description='Train Transformer for 2048')
    ...
    # Logging arguments
    parser.add_argument('--log-dir', type=str, default='results/training_curves/transformer',
